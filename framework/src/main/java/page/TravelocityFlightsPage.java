...
public class TravelocityFlightsPage extends AbstractPage{
    ...
    protected TravelocityFlightsPage(WebDriver driver) {
        super(driver);
    }

    public TravelocityFlightsPage changeTripType(String tripType) {
        findElementByLocatorAndClick(By.xpath("//span[text()='" + tripType + "']"));
        LOGGER.log(Level.INFO, "Trip type is changed by [{}]", tripType);
        return this;
    }

    public TravelocityFlightsPage addMaxNumberOfFlightForm() {
        try{
    ...
    public TravelocityFlightsPage enterFromLocation(String fromLocation) {
    ...
    public TravelocityFlightsPage enterToLocation(String toLocation) {
